...
const HeroSection = () => {
  return (
    <header className="relative teal-gradient text-primary-foreground pt-20 pb-24 px-6 text-center overflow-hidden">
      ...
      >
        <motion.div
          ...
          className="w-36 h-36 rounded-full border-4 border-burnt bg-cream p-1 shadow-2xl mb-8 overflow-hidden flex items-center justify-center"
        >
          <img
            src={mssLogo}
        ...
        <motion.h1
          ...
          className="font-display text-4xl md:text-6xl lg:text-7xl font-bold leading-none mb-4 tracking-tight"
        >
        ...
        <motion.p
          ...
          className="font-display italic text-xl md:text-2xl text-burnt-light mb-10"
        ...
        <motion.div
          ...
          className="space-y-3"
        >
          <h2 className="font-body text-2xl md:text-3xl uppercase tracking-[0.25em] font-light">
            Class of 2026
          </h2>
          <div className="flex flex-wrap items-center justify-center gap-3 md:gap-4 font-body text-sm md:text-base opacity-90">
