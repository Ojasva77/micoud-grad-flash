...
const programItems: Item[] = [
  ...
  { chapter: "Procession", event: "Entrance of Graduates", person: "Music Rendition" },
  { chapter: "Anthem", event: "National Anthem", person: "Instrumental" },
  { chapter: "Invocation", event: "Prayers", person: "Renaldo St. Helene" },
  { chapter: "Welcome", event: "Welcome / Year Head Remarks", person: "Mr. D. Moffat" },
  ...
  { chapter: "Remarks", event: "Remarks", person: "District Representative Micoud North — Hon. Jeremiah Norbert, Minister for Home Affairs, Crime Prevention, Conflict Resolution and Persons with Disabilities" },
  { chapter: "Address", event: "Principal Remarks", person: "Mrs. Flora Emmanuel-Joseph" },
  { chapter: "Rendition", event: "Rendition", person: "MSS Choir" },
  { chapter: "Certificates", event: "Presentation of School Leaving Certificates", person: "Year Head & Homeroom Sponsors" },
  { chapter: "Introduction", event: "Introduction of Guest Speaker", person: "Mr. Raphael Jn. Charles" },
  { chapter: "Feature", event: "Feature Address", person: "Mrs. Annie Greaves Maryat" },
  { chapter: "Token", event: "Presentation to Guest Speaker", person: "Kievan Abbott" },
  { chapter: "Performance", event: "Micoud Secondary Dance Club Performance" },
  { chapter: "Discipline", event: "Presentation of Discipline Awards", person: "Deans of Discipline & Homeroom Sponsors" },
  { chapter: "Academic", event: "Presentation of Individual Subject Awards" },
  {
    chapter: "Sports Awards",
    event: "Presentation of Sports Awards",
    group: true,
    sub: [
  ...
  },
  {
    ...
    sub: [
      ...
      "Resilience Awards",
      "Homeroom Sponsor Awards",
    ],
  },
  { chapter: "Rendition", event: "Rendition", person: "Jaheim Malzaire" },
  {
  ...
  { chapter: "Valedictory", event: "Valedictory Address", person: "Quiana Monlouis" },
  { chapter: "Song", event: "Graduation Song", person: "\"We Pray\" by Popcaan" },
  { chapter: "Thanks", event: "Vote of Thanks", person: "Haylee Annerville" },
